...
public class Database extends SQLiteOpenHelper {
    ...
    public int updateproductname(String productname, int productid, String productdescription, double productprice, int productquantity) {
        SQLiteDatabase udb = getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(PRODUCT_COL_1, productname);
        cv.put(PRODUCT_COL_2, productquantity);
        cv.put(PRODUCT_COL_3, productprice);
        cv.put(PRODUCT_COL_4, productdescription);
